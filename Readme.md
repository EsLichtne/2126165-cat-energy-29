...
Сайт состоит из трёх страниц: главной, каталога и страницы отправки заявки.
...
- Просмотр местоположения магазина на интерактивной карте (использован API [Яндекс.Карт🡕](https://yandex.ru/maps-api/products));
